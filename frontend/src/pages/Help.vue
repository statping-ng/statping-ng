...
<a href="https://github.com/handelsblattgroup/statping/labels/priority"><img src="https://img.shields.io/github/issues/statping-ng/statping-ng/priority?color=blue&label=priority"></a> <a href="https://github.com/handelsblattgroup/statping/labels/bug"><img src="https://img.shields.io/github/issues/statping-ng/statping-ng/bug?color=red&label=bugs"></a> <a href="https://github.com/handelsblattgroup/statping/labels/feature"><img src="https://img.shields.io/github/issues/statping-ng/statping-ng/feature?color=pink&label=features"></a>
</p>

<h1>Docker</h1>

<p>View the <a href="https://github.com/handelsblattgroup/statping/wiki/Docker" target="_blank">Docker Wiki</a> for more information and advanced usage.</p>
...
<p>View the <a href="https://github.com/handelsblattgroup/statping/wiki/Mac" target="_blank">Mac Wiki</a> for more information and other methods.</p>
...
<p>View the <a href="https://github.com/handelsblattgroup/statping/wiki/Linux" target="_blank">Linux Wiki</a> for more information and other methods.</p>
...
<p>Download the <a href="https://github.com/handelsblattgroup/statping/releases/latest" target="_blank">latest version</a> as an <code>.exe</code> from <a href="https://github.com/handelsblattgroup/statping/releases/latest" target="_blank">Releases</a>. View the <a href="https://github.com/handelsblattgroup/statping/wiki/Windows" target="_blank">Windows Wiki</a> for more information and other methods.</p>
...
<p>Statping is an awesome Status Page generator that allows you to create your own plugins with Golang Plugins! You don&rsquo;t need to request a PR or even tell us about your plugin. Plugin&rsquo;s are compiled and then send as a binary to the Statping <code>/plugins</code> folder. Test your plugins using the <code>statup test plugin</code> command, checkout the <a href="https://github.com/handelsblattgroup/statping/wiki/Statping-Plugins" target="_blank">Plugin Wiki</a> to see detailed information about creating plugins.</p>
...
<p>If you want a deeper view of your applications status, you can use Grafana and Prometheus to graph all types of data about your services. Read more about the <a href="https://github.com/handelsblattgroup/statping/wiki/Prometheus-Exporter" target="_blank">Prometheus Exporter</a></p>
...
<p align="center">
<a href="https://github.com/handelsblattgroup/statping/wiki/Notifier-Example">Example Code</a> | <a href="https://github.com/handelsblattgroup/statping/wiki/Notifier-Events">Events</a> | <a href="https://github.com/handelsblattgroup/statping/tree/master/notifiers">View Notifiers</a></p>
...
<p>Statping has the <code>Notifier</code> interface which you&rsquo;ll need to include in your notifier. Statping includes many other events/triggers for your notifier, checkout <a href="https://github.com/handelsblattgroup/statping/wiki/Notifier-Events">Notifier Events</a> to see all of them.</p>
...
<p>To add a notifier to the Statping application, simply append your Notifier in the <code>AttachNotifiers()</code> function inside of <a href="https://github.com/handelsblattgroup/statping/blob/master/core/core.go" target="_blank">core/core.go</a>.</p>
...
<h6><a href="https://github.com/handelsblattgroup/statping/blob/master/core/core.go#L183" target="_blank">AttachNotifiers</a></h6>
...
- or download tar.gz file from <a href="https://github.com/handelsblattgroup/statping/releases/latest" target="_blank">Latest Releases</a> and extract for <code>statping</code>.</p>
...
<li><code>DELETE FROM failures WHERE created_at &lt; '2020-02-21 00:00:00';</code> // Delete failures older than</li>
	...
	<div class="col-12" v-if='tab === "Bulk Import Services"'>
		...
		<span class="spacer"></span>
		<div v-pre>
				<p>You can import multiple services when Statping first loads by creating a file named <a href="https://github.com/handelsblattgroup/statping/wiki/services.yml" target="_blank">services.yml</a> in the working directory for Statping. It will insert the new service into the database, and will not be re-added on reboot. All services must be an array under the <code>services:</code> field.</p>
...
<pre><code>sha256(name:EXAMPLEdomain:HTTP://DOMAIN.COMport:8080type:HTTPmethod:GET)
	...
	<div class="col-12" v-if='tab === "Environment Variables"'>
		...
		<span class="spacer"></span>
		<div v-pre>
				<p>This page will list all environment variables that could be passed into Statping. You can see all default values in <a href="https://github.com/handelsblattgroup/statping/blob/dev/utils/env.go" target="_blank">utils/env.go</a> file under the <code>InitEnvs()</code> function.</p>
...
<p>With LetsEncrypt enabled, Statping will run through the SSL process and create the SSL certs in the <code>certs</code> folder. Read more about the SSL Process on the <a href="https://github.com/handelsblattgroup/statping/wiki/SSL" target="_blank">SSL Wiki</a>.
...
<li><p><code>PREFIX</code>                    - A Prefix for each value in <a href="https://github.com/handelsblattgroup/statping/wiki/Prometheus-Exporter" target="_blank">Prometheus /metric exporter</a></p></li>
...
binary. The <a href="https://github.com/handelsblattgroup/statping/blob/master/Makefile" target="_blank">Makefile</a>
...
don&rsquo;t forget adding the related GitHub Issue ID like this: <code>[#270](https://github.com/handelsblattgroup/statping/issues/270)</code>
...
<pre><code class="language-bash">~] changelog new &quot;Fix zooming out on graph doesn't load additional data ([#270](https://github.com/handelsblattgroup/statping/issues/270))&quot;
[0] New Feature          (Added)
[1] Bug Fix              (Fixed)
...
<p>When you mount <code>server.crt</code> and <code>server.key</code> to the <code>/app</code> directory, Statping will run a HTTPS server on port 443. Checkout the <a href="https://github.com/handelsblattgroup/statping/wiki/SSL" target="_blank">SSL Wiki</a> documentation to see more information about this.</p>
...
networks:
  ...
  database:
	...
	<div class="col-12" v-if='tab === "Docker-Compose"'>
		...
		<span class="spacer"></span>
		<div v-pre>
				<p>This page includes multiple docker-compose.yml setups for you to run. There are many environment variables for additional settings and features, checkout the <a href="https://github.com/handelsblattgroup/statping/wiki/Environment-Variables" target="_blank">Environment Variables Wiki</a> to see them all.</p>
...
<p>Grafana is an awesome metric visualizer that allows you to create some awesome dashboards. We&rsquo;ve already created a <a href="https://grafana.com/grafana/dashboards/6950" target="_blank">Grafana Dashboard</a> that you can easy import! Checkout the <a href="https://github.com/handelsblattgroup/statping/wiki/Prometheus-Exporter" target="_blank">Grafana Wiki</a> and the <a href="https://github.com/handelsblattgroup/statping/wiki/Prometheus-Exporter" target="_blank">Prometheus Exporter Wiki</a> for more details.</p>
...
<pre><code>VERSION=$(curl -s &quot;https://github.com/handelsblattgroup/statping/releases/latest&quot; | grep -o 'tag/[v.0-9]*' | awk -F/ '{print $2}')
wget https://github.com/handelsblattgroup/statping/releases/download/$VERSION/statping-linux-x64.tar.gz
...
<p>You can even run Statping on your Raspberry Pi by installing the precompiled binary from <a href="https://github.com/handelsblattgroup/statping/releases/latest" target="_blank">Latest Releases</a>. For the Raspberry Pi 3 you&rsquo;ll want to download the <code>statping-linux-arm7.tar.gz</code> file. Be sure to change <code>VERSION</code> to the latest version in Releases, and include the &lsquo;v&rsquo;.</p>

<pre><code>VERSION=$(curl -sL &quot;https://github.com/handelsblattgroup/statping/releases/latest&quot; | grep -o 'tag/[v.0-9]*' | awk -F/ '{print $2}' | head -n1)
wget https://github.com/handelsblattgroup/statping/releases/download/$VERSION/statping-linux-arm-7.tar.gz
...
<p>The Docker image is using the Statping Alpine binary since it&rsquo;s so incredibly small. You can run it on your own alpine image by downloading <code>statping-linux-alpine.tar.gz</code> from <a href="https://github.com/handelsblattgroup/statping/releases/latest" target="_blank">Latest Releases</a>.</p>
...
<p>Currently, Statping only works on Windows 64-bit computers. Just download the exe file from <a href="https://github.com/handelsblattgroup/statping/releases/latest" target="_blank">Latest Releases</a> and run it in your command prompt. It will create a HTTP server on port 8080, so you can visit <code>http://localhost:8080</code> to see your Statping Status Page.</p>
...
<p>Unfortunately, Statping only works on Windows 64-bit processors. If you have more than 4gb of ram, there&rsquo;s a good chance you already have a 64-bit processor. Download the <a href="https://github.com/handelsblattgroup/statping/releases/latest" target="_blank">Latest Releases</a> of Statping, extract the ZIP file, then double click on the <code>statping.exe</code> file. You can use a SQLite database for a quick setup, or connect to a local/remote Postgres or MySQL database server.</p>
...
<p>You can include multiple environment variables to the configg file. If you include <code>DB_CONN</code> Statping will attempt to automatically connect to that database. View the <a href="https://github.com/handelsblattgroup/statping/wiki/Config-with-.env-File" target="_blank">Full List of Environment Variables</a> to fully customize this config.</p>
...
<ul>
<li><p><a href="https://github.com/handelsblattgroup/statping/blob/master/handlers/routes.go" target="_blank">handlers/routes.go</a> - Contains all the HTTP request routes</p></li>

<li><p><a href="https://github.com/handelsblattgroup/statping/blob/master/cmd/commands.go" target="_blank">cmd/commands.go</a> - CLI Commands</p></li>

<li><p><a href="https://github.com/handelsblattgroup/statping/blob/master/types/services/struct.go" target="_blank">types/service/struct.go</a> - Service struct</p></li>

<li><p><a href="https://github.com/handelsblattgroup/statping/blob/master/types/core/struct.go" target="_blank">types/core/struct.go</a> - Core struct</p></li>
</ul>
...
<li>Travis-CI tests the Statping API using <a href="https://github.com/handelsblattgroup/statping/blob/master/source/tmpl/postman.json" target="_blank">Postman</a>.</li>
...
<li>Binaries are code signed using the official <a href="https://github.com/handelsblattgroup/statping/wiki/PGP-Signature" target="_blank">PGP key</a> and compressed.</li>
...
<li>Travis-CI uploads the <a href="https://github.com/handelsblattgroup/statping/releases" target="_blank">latest release</a> as a tagged version on Github.</li>
...
<p>And that&rsquo;s it! Statping is ready to be shipped and installed.</p>
	...
	<div class="col-12" v-if='tab === "Makefile"'>
		...
		<span class="spacer"></span>
		<div v-pre>
				<p>Here&rsquo;s a simple list of Makefile commands you can run using <code>make</code>. The <a href="https://github.com/handelsblattgroup/statping/blob/master/Makefile" target="_blank">Makefile</a> may change often, so i&rsquo;ll try to keep this Wiki up-to-date.</p>

<p align="center">
<a href="https://github.com/handelsblattgroup/statping/blob/master/Makefile">View Makefile</a>
</p>
...
<p align="center">
<a href="https://github.com/handelsblattgroup/statping/blob/master/handlers/graphql/schema.graphql">View schema.graphql</a>
</p>
...
<p>The code for handling GraphQL requests is in <a href="https://github.com/handelsblattgroup/statping/tree/master/handlers/graphql" target="_blank">handlers/graphql</a> and is using <a href="https://github.com/99designs/gqlgen" target="_blank">gqlgen</a> to automatically generate the schema based on the golang structs.</p>
...
<p>This .env file will include additional variables in the future, subscribe to this repo to keep up-to-date with changes and updates.</p>
	...
	<div class="col-12" v-if='tab === "config.yml"'>
		...
		<span class="spacer"></span>
		<div v-pre>
				<p>The <code>config.yml</code> file contains all of the Statping database settings and API keys/secrets. When Statping loads, it will attempt to open this file to parse it&rsquo;s core values. You can view the Go type file on <a href="https://github.com/handelsblattgroup/statping/blob/master/types/types.go#L40" target="_blank">types/types.go</a>.</p>
...
<p>You technically don&rsquo;t need this <code>config.yml</code> file to run Statping. You can also run the Statping server by including environment variables when you start the server. You can view all the available variables by viewing the <a href="https://github.com/handelsblattgroup/statping/wiki/Config-with-.env-File" target="_blank">Config with .env</a> Wiki page.</p>
...
<ol>
<li>Download the Statping <code>tar.gz</code> file from <a href="https://github.com/handelsblattgroup/statping/releases/latest" target="_blank">Latest Releases</a> and extract the <code>statping</code> binary and the <code>statup.asc</code> file.</li>
...
<div class="col-12 shadow-md mt-5">
	<div class="text-dim" v-pre>
		<p align="center">
<a href="https://statping.com">Statping.com</a> | <a href="https://demo.statping.com">Demo</a> | <a href="https://hub.docker.com/r/statping/statping">Docker</a> | <a href="https://github.com/handelsblattgroup/statping/wiki/Notifiers">Notifiers</a> | <a href="https://documenter.getpostman.com/view/1898229/RzfiJUd6">API</a>
</p>
