...
<div>
    ...
    <p class="mt-2">
        Checkout the <a href="https://github.com/handelsblattgroup/statping/blob/master/types/services/struct.go">Service struct</a> and the <a href="https://github.com/handelsblattgroup/statping/blob/master/types/failures/struct.go">Failures struct</a> and create variables in golang template format.
    </p>
