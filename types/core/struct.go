...
type OAuth struct {
    ...
    KeycloakEnabled      	 null.NullBool `gorm:"column:keycloak_enabled" json:"keycloak_enabled"`
    ...
    KeycloakEndpointToken 	 string        `gorm:"column:keycloak_endpoint_token" json:"keycloak_endpoint_token" scope:"admin"`
    KeycloakEndpointUserInfo string 	   `gorm:"column:keycloak_endpoint_userinfo" json:"keycloak_endpoint_userinfo" scope:"admin"`
    KeycloakScopes       	 string        `gorm:"column:keycloak_scopes" json:"keycloak_scopes"`
	KeycloakAdminGroups 	 string        `gorm:"column:oauth_custom_admin_groups" json:"oauth_custom_admin_groups"`
